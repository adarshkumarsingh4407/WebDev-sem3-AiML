...
const filePath2=path.join("AIML-G","lecture 5","core_modules.js");
...
console.log("A")
const data2=fs.readFileSync("sample.txt","utf-8");  //synchromous
console.log(data);
console.log("B")
console.log("A")
...
const hash2=crypto.createHmac("sha256",salt).update(password).digest("hex");
console.log(hash)
